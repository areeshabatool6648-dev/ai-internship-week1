...
Rewrite the following follow-up question into a standalone question. If already standalone, return it unchanged. Only output the rewritten question.
...
def ask_rag(question):
    ...
    rag_prompt = f"""Answer using ONLY the context below. If not covered, say "I don't know based on the provided document."
...
print("Conversational RAG tool ready! Type 'quit' to exit.")
